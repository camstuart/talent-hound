...
- Store provider secrets only in Windows Credential Manager or macOS Keychain, behind an interface with no file-backed implementation, and never return one to the frontend.
